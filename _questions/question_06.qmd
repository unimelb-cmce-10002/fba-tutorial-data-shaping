...
Complete the code below to join `firm_info` onto `asx_with_pe` using `gvkey`.

```{r}
#| eval: false

# recreating firm_info for those that did not successfully complete exercise 2
firm_info <-
    firm_codes |>
